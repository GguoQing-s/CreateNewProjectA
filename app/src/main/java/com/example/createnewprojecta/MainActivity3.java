...
public class MainActivity3 extends AppCompatActivity {
            ...
            public void onItemClick(View view, int position) {
                switch (datas.get(position)) {
                    ...
                    case "QQ空间":
                        ...
                        break;
                    case "新浪微博":
                        nativeShareTool.shareToSinaFriends(MainActivity3.this, false,Resource.getInstance(mContext).getPicFile().getAbsolutePath());
                        break;*/
                }
            }
        });
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyHolder> {
        ...
        public MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            return new MyHolder(LayoutInflater.from(MainActivity3.this).inflate(R.layout.recyclerview_item, viewGroup, false));
        }
